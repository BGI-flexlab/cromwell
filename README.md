...
For example, `$ java -jar cromwell-28.jar`. You will get a usage message like the following:

```
cromwell 28-78824f3-SNAP
...
### --inputs
Workflow inputs are technically optional, but highly recommended so that inputs are not hardcoded into the workflow
source file.
